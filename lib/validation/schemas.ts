...
export const researchThemeSchema = z.object({
  ...
  related_project_slugs: z.array(z.string()).optional().default([]),
  related_publication_slugs: z.array(z.string()).optional().default([]),
...
export const publicationSchema = z.object({
  ...
  research_theme_slugs: z.array(z.string()).optional().default([]),
  related_project_slugs: z.array(z.string()).optional().default([]),
...
export const projectSchema = z.object({
  ...
  research_theme_slugs: z.array(z.string()).optional().default([]),
  member_slugs: z.array(z.string()).optional().default([]),
  links: z.array(linkSchema).optional().default([]),
