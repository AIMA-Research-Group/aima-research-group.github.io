  ...
  return (
    <>
      ...
      <main id="main-content">
        <PageHero eyebrow="People" title="The research community behind AIMA" description="AIMA brings together leaders, core members, mentors, collaborators, affiliated faculty, and research members across institutions." />
