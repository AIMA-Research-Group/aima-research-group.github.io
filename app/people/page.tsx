  ...
  return (
    <>
      ...
      <main id="main-content">
        <PageHero eyebrow="People" title="The research community behind AIMA" description="Founder, mentors, core members, and collaborators will be shown here as real profiles are added." />
